...
/*
	...
	Copied from the odin vendor:egl
	Zlib License 
*/
package egl
...
foreign egl {
	...
	GetConfigs :: proc(display: Display, config: [^]Config, config_size: i32, num_configs: ^i32) -> Boolean ---
...
load_extensions :: proc() {
	...
	cast(type_of(GetPlatformDisplayEXT))GetProcAddress("eglGetPlatformDisplayEXT")
	CreatePlatformWindowSurfaceEXT =
	cast(type_of(CreatePlatformWindowSurfaceEXT))GetProcAddress(
		"eglCreatePlatformWindowSurfaceEXT",
	)
}

GetPlatformDisplayEXT: proc "c" (
	platform: Platform,
	native_display: rawptr,
	attrib_list: ^i32,
) -> Display

CreatePlatformWindowSurfaceEXT: proc "c" (
	display: Display,
	config: Config,
